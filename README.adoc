...
* https://github.com/bradmac[Brad McEnvoy] from http://milton.io[Milton.io] for tips on setting up the Milton Webdav server. We use the community edition
  for testing the webdav provider.
