...
class CopyMoveOperations {
	 ...
	 */
	static final Closure ONLY_NEWER = { VfsURI from, VfsURI to ->
...
//		}
	 ...
	 */
    @CompileStatic
	static def copy( VfsURI from,VfsURI to,boolean smash,def overwrite,boolean recursive,def filter=null ) {
...
//		}
	 ...
	 */
    @CompileStatic
	static def move( VfsURI from,VfsURI to,boolean smash,def overwrite,boolean intermediates=true,boolean noCreateSubFolder=false) {
//		def fromType= from.type
//		def toType= to.type
//		assert fromType != FILE_OR_FOLDER
//
...
//        }
     ...
     */
    @CompileStatic
    private static void _moveItem(VfsURI from,VfsURI to,boolean intermediates) {
//        def fromType= from.type
//        def toType= to.type
//
...
//        }
     ...
     */
    @CompileStatic
    private static def _recursiveMoveAndOverwrite(VfsURI from,VfsURI to, Closure overwrite) {
...
//		return selector
	 ...
	 * 
	 */
	private static def _copyFromSourceFile(VfsURI from,VfsURI to,boolean smash,Closure overwrite,FileSelector selector) {
//		def toType= to.type
...
//		}
	 ...
	 * @return
	 */
	private static def _recursiveDirCopyNoSmash(VfsURI from,VfsURI to,FileSelector selector,Closure overwrite) {
...
//		}
    ...
    private static FileSelector _currySelectorWithOverwrite(VfsURI from,VfsURI to, FileSelector selector,Closure overwrite) {
//        [
//            includeFile : {
